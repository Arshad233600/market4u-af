  ...
  return (
    <div className="pb-20 min-h-screen bg-gray-50">
        <div className="bg-white border-b border-gray-200 sticky top-0 z-10 px-4 py-4 flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-gray-800">{t('seller_info')}</h2>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8 flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div className="text-center md:text-right flex-1">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 mt-4 text-sm text-gray-500 justify-center md:justify-start">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-4 border-r-4 border-brand-500 pr-3">

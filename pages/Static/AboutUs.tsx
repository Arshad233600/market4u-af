  ...
  return (
    <div className="bg-ui-surface min-h-screen pb-12">
      ...
      <div className="max-w-5xl mx-auto px-4 -mt-10 relative z-20">
         ...
         {/* Story Section */}
         <div className="bg-ui-surface rounded-3xl shadow-xl p-8 md:p-10 mb-8 border border-ui-border">
            <h2 className="text-2xl font-bold text-ui-text mb-6 border-b border-ui-border pb-4 flex items-center gap-2">
                <span className="w-2 h-8 bg-brand-600 rounded-full"></span>
                داستان ما
            </h2>
            <div className="space-y-4 text-ui-muted leading-8 text-justify">
                <p>
                ...
                <p>
                   این پلتفرم توسط <strong className="text-ui-text">عبدالله ارشد</strong>، متخصص IT و Cloud، ایجاد شده است. او با سال‌ها تجربه در حوزه تکنولوژی، پشتیبانی سیستم‌ها، شبکه و توسعه پروژه‌های دیجیتال، همواره به دنبال راهی بوده تا تکنولوژی را در خدمت مردم قرار دهد.
                </p>
                <p>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
             <div className="bg-gradient-to-br from-brand-50 to-white border border-brand-100 p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                 ...
                 <h3 className="font-bold text-ui-text text-xl mb-3">ماموریت ما</h3>
                 <p className="text-sm text-ui-muted leading-7 text-justify">
             ...
             <div className="bg-gradient-to-br from-purple-50 to-white border border-purple-100 p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                 ...
                 <h3 className="font-bold text-ui-text text-xl mb-3">چشم‌انداز ما</h3>
                 <p className="text-sm text-ui-muted leading-7 text-justify">
         ...
         {/* Values Section */}
         <div className="bg-ui-surface rounded-3xl shadow-sm border border-ui-border p-8 mb-8">
            <h3 className="text-xl font-bold text-ui-text mb-8 text-center">ارزش‌های بنیادین ما</h3>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                {[
                    ...
                    <div key={idx} className="flex flex-col items-center text-center group">
                         ...
                         <span className="text-sm font-bold text-ui-muted">{val.title}</span>
                    </div>
                ))}
            </div>
         </div>
         ...
         <div className="bg-gradient-to-r from-red-50 via-white to-pink-50 border border-red-100 rounded-3xl p-8 md:p-12 mb-8 text-center relative overflow-hidden">
             ...
             <div className="relative z-10">
                 ...
                 <h3 className="text-2xl md:text-3xl font-bold text-ui-text mb-4">حمایت از Market4U ❤️</h3>
                 <p className="text-ui-muted mb-8 max-w-2xl mx-auto leading-8 text-lg">
                 ...
                 <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                     <div className="bg-ui-surface px-6 py-4 rounded-2xl shadow-sm border border-ui-border flex items-center gap-3 w-full md:w-auto justify-center">
                         <div className="bg-blue-50 p-2 rounded-lg"><Icon name="CreditCard" size={24} strokeWidth={1.8} className="text-blue-600" /></div>
                         <div className="text-right">
                             <p className="text-xs text-ui-muted font-bold mb-0.5">PayPal Donation</p>
                             <p className="text-ui-text font-mono font-bold select-all" dir="ltr">Arshad233600@gmail.com</p>
                         </div>
                     </div>
                 </div>
                 <p className="text-xs text-ui-muted mt-4">هر حمایت شما، نیرویی بزرگ برای ادامه این مسیر خواهد بود.</p>
             </div>
         </div>

         {/* Founder Message */}
         <div className="bg-gray-900 text-white rounded-3xl p-8 md:p-12 text-center relative shadow-2xl">
             <Icon name="Quote" size={24} strokeWidth={1.8} className="w-16 h-16 text-ui-muted absolute top-6 left-6 rotate-180 opacity-50" />
             <div className="relative z-10 max-w-3xl mx-auto">
                 ...
                 <div className="flex flex-col items-center gap-2">
                     ...
                     <div>
                         ...
                         <div className="text-xs text-ui-muted">بنیان‌گذار Market4U</div>
                     </div>
                 </div>
             </div>
         </div>

...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 pb-20 bg-white">
      <div className="flex items-center gap-3 mb-8 pb-4 border-b">
         <div className="bg-brand-50 p-3 rounded-2xl">
            <Icon name="Lock" size={24} strokeWidth={1.8} className="text-brand-600" />
         </div>
         <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">سیاست حفظ حریم خصوصی</h1>
            <p className="text-sm text-gray-500 mt-1">تعهد ما به حفاظت از داده‌های شما</p>
         </div>
      </div>
      ...
      <div className="space-y-10">
         ...
         <section>
             ...
             <div className="grid md:grid-cols-2 gap-4">
                 <div className="bg-gray-50 p-4 rounded-xl">
                     <h3 className="font-bold text-sm text-gray-900 mb-2">اطلاعات هویتی</h3>
                     <p className="text-xs text-gray-600 leading-5">نام، شماره تلفن، آدرس ایمیل و عکس پروفایل که هنگام ثبت‌نام وارد می‌کنید.</p>
                 </div>
                 <div className="bg-gray-50 p-4 rounded-xl">
                     <h3 className="font-bold text-sm text-gray-900 mb-2">اطلاعات دستگاه و موقعیت</h3>
                     <p className="text-xs text-gray-600 leading-5">مدل دستگاه، آدرس IP و موقعیت تقریبی (برای نمایش آگهی‌های نزدیک).</p>
                 </div>
                 <div className="bg-gray-50 p-4 rounded-xl">
                     <h3 className="font-bold text-sm text-gray-900 mb-2">فعالیت‌ها</h3>
                     <p className="text-xs text-gray-600 leading-5">آگهی‌های بازدید شده، جستجوها و پیام‌های رد و بدل شده در چت امن.</p>
                 </div>
                 <div className="bg-gray-50 p-4 rounded-xl">
                     <h3 className="font-bold text-sm text-gray-900 mb-2">کوکی‌ها</h3>
                     <p className="text-xs text-gray-600 leading-5">داده‌های ذخیره شده در مرورگر برای حفظ نشست کاربری و تنظیمات.</p>
                 </div>
             </div>
         </section>
         ...
         <section>
             ...
             <ul className="list-disc list-inside space-y-2 text-sm text-gray-600 pr-4 leading-7">
         ...
         <section>
             ...
             <p className="text-gray-600 text-sm leading-7 text-justify mb-4">
                 ما هرگز اطلاعات شخصی شما را به شرکت‌های ثالث نمی‌فروشیم. اطلاعات شما تنها در موارد زیر به اشتراک گذاشته می‌شود:
             </p>
             <ul className="space-y-2 text-sm text-gray-600 pr-4">

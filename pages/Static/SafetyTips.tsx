    ...
    <div className="max-w-5xl mx-auto px-4 py-8 pb-20">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-800 border-r-4 border-brand-500 pr-3">قوانین طلایی برای خریداران</h2>
              
              <div className="flex gap-4">
                  <div className="bg-red-50 p-3 rounded-full h-fit text-red-600"><Icon name="Banknote" size={24} strokeWidth={1.8} /></div>
                  <div>
                      <h3 className="font-bold text-gray-900 mb-1">هرگز بیعانه ندهید</h3>
              ...
              <div className="flex gap-4">
                  ...
                  <div>
                      <h3 className="font-bold text-gray-900 mb-1">قرار در مکان عمومی</h3>
                      <p className="text-sm text-gray-600 leading-6 text-justify">
              ...
              <div className="flex gap-4">
                  ...
                  <div>
                      <h3 className="font-bold text-gray-900 mb-1">اطلاعات بانکی را ندهید</h3>
                      <p className="text-sm text-gray-600 leading-6 text-justify">
          ...
          <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-800 border-r-4 border-brand-500 pr-3">قوانین طلایی برای فروشندگان</h2>

              <div className="flex gap-4">
                  <div className="bg-green-50 p-3 rounded-full h-fit text-green-600"><Icon name="Banknote" size={24} strokeWidth={1.8} /></div>
                  <div>
                      <h3 className="font-bold text-gray-900 mb-1">رسید جعلی را بشناسید</h3>
                      <p className="text-sm text-gray-600 leading-6 text-justify">
              ...
              <div className="flex gap-4">
                  ...
                  <div>
                      <h3 className="font-bold text-gray-900 mb-1">ارتباط فقط در چت Market4U</h3>
                      <p className="text-sm text-gray-600 leading-6 text-justify">

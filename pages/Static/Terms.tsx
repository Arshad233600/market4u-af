  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 pb-20 bg-white">
      <div className="flex items-center gap-3 mb-8 pb-4 border-b">
         ...
         <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">شرایط و قوانین استفاده</h1>
            <p className="text-sm text-gray-500 mt-1">آخرین بروزرسانی: ۱۰ جدی ۱۴۰۳</p>
         </div>
      </div>
      ...
      <div className="space-y-10">
         ...
         <section>
             ...
             <ul className="list-disc list-inside space-y-2 text-sm text-gray-600 pr-4">
         ...
         <section>
             ...
             <p className="text-sm text-gray-600 mb-2">انتشار محتوا یا فروش اقلام زیر اکیداً ممنوع است و منجر به مسدودسازی دائم حساب و پیگرد قانونی خواهد شد:</p>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-600 pr-4">
         ...
         <section>
             ...
             <div className="bg-gray-50 border border-gray-200 p-4 rounded-xl text-sm text-gray-700 leading-7 text-justify">
